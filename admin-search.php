...
<br>
	...
	<h4>Find Course Info By Student Name</h4>
		<form action="admin-search.php" method="post">
			<div class="form-group">
			  <label for="name">Username:</label>
			  <input type="text" class="form-control" name="stuName" placeholder="Enter Username" >
			</div>
...
{	
	...
	$query = "SELECT Course,Student,Grade FROM stu_course";
